...
def setup_training_options(
    ...
    cfg_specs = {
        ...
        '11gb-gpu-256': dict(ref_gpus=1, kimg=25000, mb=8, mbstd=8, fmaps=0.5, lrate=0.002, gamma=5, ema=20, ramp=None,map=8),  # uses mixed-precision, 11GB GPU - 256px
    ...
    if cfg == 'auto':
        ...
        print("Calculated spec.gamma: ")
        print(spec.gamma)
        print("Calculated spec.mb: ")
        print(spec.mb)
        print("Calculated spec.mbstd: ")
        print(spec.mbstd)
        print("Calculated spec.fmaps: ")
        print(spec.fmaps)
        print("Calculated spec.lrate: ")
        print(spec.lrate)
        print("Calculated spec.ema: ")
        print(spec.ema)

    print("setting up training.. 7")
...
def main():
    ...
    group.add_argument('--cfg',   help='Base config (default: auto)', choices=['auto', 'stylegan2', '11gb-gpu-256', 'paper256', 'paper512', 'paper1024', 'cifar', 'cifarbaseline'])
